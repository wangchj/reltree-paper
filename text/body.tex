...
\subsubsection{Category 1 - O(log N)}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=6.5in]{images/root-al-wire.pdf}
\caption{Example of a tree in nested set model.\label{fig-root-al}}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=6.5in]{images/root-ns-wire.pdf}
\caption{Example of a tree in nested set model.\label{fig-root-ns}}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=6.5in]{images/order.pdf}
